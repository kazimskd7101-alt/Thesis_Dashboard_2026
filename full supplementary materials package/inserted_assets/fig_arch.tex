...
% Clean routed branch arrows with separate landing points
...
\caption{Single-scale and multi-scale gated CNN model architecture used in the revised experiment package.}
